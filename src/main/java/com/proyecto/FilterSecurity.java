...
public class FilterSecurity implements Filter  {
	...
	private boolean checkPermissionsUri(HttpServletRequest httpServletRequest) {
		...
		return httpServletRequest.getRequestURI().equals("") ||  httpServletRequest.getRequestURI().equals("/") 
				|| httpServletRequest.getRequestURI().equals("/Home") || httpServletRequest.getRequestURI().equals("/usuarios/accede") ||
